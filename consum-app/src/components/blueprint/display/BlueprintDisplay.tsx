    ...
    <div className="space-y-4">
      {section.items.map((item, index) => {
        ...
        switch (item.type) {
          ...
          case 'habit':
            return (
              <div key={`${section.id}-habit-${index}`} className="rounded-2xl border border-border/70 bg-background/80 p-5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
              ...
              <div key={`${section.id}-trigger-${index}`} className="rounded-2xl border border-border/70 bg-background/80 p-5">
                <div className="space-y-3">
                  <div>
                    ...
                    <h4 className="text-base font-semibold text-foreground leading-snug">{item.situation}</h4>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Action</p>
                    <p className="mt-1 text-sm text-muted-foreground leading-relaxed">{item.action}</p>
                  </div>
                  {item.timeframe && (
