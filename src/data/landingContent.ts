...
export const PRICING_TIERS = [
  {
    ...
    price: '$0',
    period: 'forever',
    description: 'Kick off with two high-signal blueprints every month.',
    features: ['2 blueprints / month', 'Standard transcript cleanup', 'History log for last 7 days'],
    cta: 'Create for free',
  ...
  },
  {
    ...
    price: '$29',
    period: 'per month',
    description: 'Unlimited digestion with accountability tracking baked in.',
    features: [
      'Unlimited blueprints & Today tracking',
      'Advanced habit blueprint engine',
  ...
  },
  {
    ...
    price: '$299',
    period: 'one-time',
    description: 'Own your learning stack outright with future updates included.',
    features: ['All Pro features forever', 'VIP office hours + templates', 'Founder-only roadmap access'],
